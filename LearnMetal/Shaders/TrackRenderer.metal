...
vertex RasterizerData single_line_point_vertex(device const VertexPoint *verts [[buffer(0)]],
                                                uint vid [[vertex_id]]) {
    RasterizerData out;
...
fragment float4 single_line_point_fragment(RasterizerData in [[stage_in]],
